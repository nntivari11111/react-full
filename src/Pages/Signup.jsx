...
const initialState = {
            ...
            <Stack spacing={4}>
              <HStack>
                ...
                <Box>
                  <FormControl id="username" isRequired>
                    ...
                    onChange={(e) => setter({type: "username", payload: e.target.value})} />
                  </FormControl>
                </Box>
              </HStack>
              ...
              <Box>
                  <FormControl id="mobile" isRequired>
                    ...
                    <Input type="number" value={state.mobile} 
  ...
  <EditablePreview />
  <EditableTextarea value={state.description} 
                    onChange={(e) => setter({type: "description", payload: e.target.value})} />
</Editable>
                </Box>
